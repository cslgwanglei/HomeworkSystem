...
public partial class Student_Susercenter : System.Web.UI.Page
{
    ...
    {
        string id = Session["sname"].ToString();
        ...
        cmd = new SqlCommand();
        cmd.Connection = con;
        cmd.CommandText = "select * from student where sno=" + id + "and spwd=" + oldpassword;
        ...
        try
        {
            ...
            {
                con.Close();
                cmd.CommandText = "update student set spwd=@apwd where sno=" + id;
