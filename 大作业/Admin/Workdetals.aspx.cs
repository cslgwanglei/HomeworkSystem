...
using Dal;
using System.IO;
public partial class Admin_Workdetals : System.Web.UI.Page
{
    string workname;
    string sno;
    string classid;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand();
        cmd.Connection = con;
        string sql = "select score,comment,tname,grade,appraise,workdata from grade where workname ='" + workname + "'";
