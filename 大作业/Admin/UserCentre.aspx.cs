...
public partial class Admin_UserCentre : System.Web.UI.Page
{
    ...
    {
        string id = Session["aname"].ToString();
        ...
        cmd = new SqlCommand();
        cmd.Connection = con;
        cmd.CommandText = "select * from admin where ano=" + id + "and apwd=" + oldpassword;
        ...
        try
        {
            ...
            {
                con.Close();
                cmd.CommandText = "update admin set apwd=@apwd where ano=" + id;
