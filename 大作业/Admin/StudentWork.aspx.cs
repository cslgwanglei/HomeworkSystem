...
using Bll;
using Mod;
public partial class Admin_StudentWork : System.Web.UI.Page
{
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            Label myLabel = (Label)e.Row.Cells[0].FindControl("Label3");
...

        {
            ...
            if (e.CommandName == "back")
            {
                ...
                if (Page.IsValid)
                {
                    ...
                    bg.UpdateGrade2(G);
                    Response.Write("<script>alert('发回成功！');location='CourseAdd.aspx'</script>");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string sql = "SELECT [workname], [cname], [sno] FROM [grade] where sno like '%" + num + "%'and done ='" + true + "' or classid like '%" + num + "%'and done ='" + true + "' ";
    ...
    {
        string sql = "SELECT [workname], [cname], [sno] FROM [grade] where done ='" + true + "'";
        this.SqlDataSource1.SelectCommand = sql;
        GridView1.DataBind();
        TextBox1.Text = "";
    }
